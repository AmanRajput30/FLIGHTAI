    ...
    <div className="flex w-full min-h-screen bg-cockpit-black font-labels">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            <label className="block text-[10px] font-bold text-instrument-grey uppercase tracking-widest mb-2">Operator Identity</label>
            <input
              type="text"
              required
              value={identifier}
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-[10px] font-bold text-instrument-grey uppercase tracking-widest">Security Passcode</label>
            </div>
            ...
            <div className="mt-2 text-right">
              <Link href="/forgot-password" className="text-[10px] font-bold text-horizon-blue hover:text-horizon-blue-bright uppercase tracking-widest transition-colors">
                Recover Clearance
              </Link>
            </div>
          </div>
        ...
        <div className="mt-6 flex justify-center">
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-instrument-grey font-bold uppercase tracking-widest">New Operator?</span>
            <Link href="/register" className="text-[10px] font-bold text-horizon-blue hover:text-horizon-blue-bright uppercase tracking-widest transition-colors">
              Request Access
            </Link>
          </div>
        </div>
