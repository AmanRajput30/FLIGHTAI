    ...
    <div className="flex w-full min-h-screen bg-aervyn-bg-dark font-labels">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            <label className="block text-[10px] font-bold text-aervyn-text-tertiary uppercase tracking-widest mb-2">Operator Identity</label>
            <input
              type="text"
              required
              value={identifier}
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-[10px] font-bold text-aervyn-text-tertiary uppercase tracking-widest">Security Passcode</label>
            </div>
            ...
            <div className="mt-2 text-right">
              <Link href="/forgot-password" className="text-[10px] font-bold text-aervyn-status-cyan hover:text-white uppercase tracking-widest transition-colors">
                Recover Clearance
              </Link>
            </div>
          </div>
        ...
        <div className="mt-6 flex justify-center">
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-aervyn-text-tertiary font-bold uppercase tracking-widest">New Operator?</span>
            <Link href="/register" className="text-[10px] font-bold text-aervyn-status-cyan hover:text-white uppercase tracking-widest transition-colors">
              Request Access
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <button 
            type="button" 
            onClick={() => googleLogin()}
            className="w-full bg-aervyn-panel-base border border-aervyn-border-subtle hover:bg-aervyn-panel-light text-aervyn-text-primary py-3 rounded font-bold text-[10px] uppercase tracking-widest transition-colors flex items-center justify-center gap-3"
          >
