      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-invert prose-sm text-gray-400">
          ...
          <div className="p-4 bg-red-900/20 border border-red-500/50 rounded-lg text-red-200 my-6">
            <strong>CRITICAL SAFETY WARNING:</strong> The data provided by Averyn is NOT intended for aeronautical navigation or operational use. Do not use this service for flight planning, separation of aircraft, or emergency response.
          </div>
